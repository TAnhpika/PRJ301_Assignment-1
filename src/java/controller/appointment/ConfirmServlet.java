...
public class ConfirmServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dal.PatientDAO patientDAO = new dal.PatientDAO();
            model.Patients patient = dal.PatientDAO.getPatientByUserId(user.getId());
            if (patient == null) {
            ...
            try {
                ...
                dal.TimeSlotDAO timeSlotDAO = new dal.TimeSlotDAO();
