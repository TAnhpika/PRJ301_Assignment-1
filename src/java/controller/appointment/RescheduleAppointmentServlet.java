...
public class RescheduleAppointmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        java.util.List<model.Appointment> appointments = new dal.AppointmentDAO().getAllAppointmentsWithDetails();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            success = dal.AppointmentDAO.updateAppointmentForReschedule(appointmentId, newDate, newSlotId);
            if (success) {
