...
public class Appointment {
    ...
    public String getFormattedStartTime() {
        return util.FormatUtils.formatTime(startTime);
    }
    
    public String getFormattedEndTime() {
        return util.FormatUtils.formatTime(endTime);
    }
    
    public String getFormattedTimeRange() {
        return util.FormatUtils.formatTimeRange(startTime, endTime);
    }
    
    public String getFormattedWorkDate() {
        return util.FormatUtils.formatDate(workDate);
    }
